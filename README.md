...
2. On the first language-server startup, the plugin downloads the pinned
   **wgsl-analyzer 2026-09-24** release from [marknefedov/wgsl-analyzer](https://github.com/marknefedov/wgsl-analyzer/releases/tag/2026-09-24).
...
3. Subsequent starts reuse the verified executable from
   `<IDE system/cache directory>/intellij-wgsl/wgsl-analyzer/2026-09-24/<target>/`.
